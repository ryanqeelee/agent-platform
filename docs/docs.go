...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/system/admin/tenants/{tenant_id}/sandbox-configs/{id}/skills/{skillId}/transcript/history": {
            "get": {
                "security": [
                    {
                        "Bearer": []
        ...
        "/system/admin/tenants/{tenant_id}/skills/installer-agent": {
            "get": {
                "security": [
                    {
                        "Bearer": []
