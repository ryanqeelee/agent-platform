...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/system/admin/chat-history-config": {
            "get": {
                "security": [
                    {
                        "Bearer": []
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/github_com_Tencent_WeKnora_internal_types.PlatformChatHistoryConfig"
                        }
                    }
                ],
                "responses": {
        ...
        "/system/admin/chat-history-stats": {
            "get": {
                "security": [
                    {
                        "Bearer": []
        ...
        "/system/admin/mcp-services/{id}/credentials": {
            "put": {
                "security": [
                    {
                        "Bearer": []
        ...
        "/system/admin/mcp-services/{id}/credentials/{field}": {
            "delete": {
                "security": [
                    {
                        "Bearer": []
        ...
        "/system/admin/mcp-services/{id}/resources": {
            "get": {
                "security": [
                    {
                        "Bearer": []
        ...
        "/system/admin/mcp-services/{id}/test": {
            "post": {
                "security": [
                    {
                        "Bearer": []
        ...
        "/system/admin/mcp-services/{id}/tool-approvals": {
            "get": {
                "security": [
                    {
                        "Bearer": []
        ...
        "/system/admin/mcp-services/{id}/tool-approvals/{tool_name}": {
            "put": {
                "security": [
                    {
                        "Bearer": []
        ...
        "/system/admin/mcp-services/{id}/tools": {
            "get": {
                "security": [
                    {
                        "Bearer": []
        ...
        "/system/admin/memory-runtime-config": {
            "get": {
                "security": [
                    {
                        "Bearer": []
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/github_com_Tencent_WeKnora_internal_types.MemoryRuntimeConfig"
                        }
                    }
                ],
                "responses": {
        ...
        "/system/admin/parser-engine-config": {
            "get": {
                "security": [
                    {
                        "Bearer": []
        ...
        "/system/admin/parser-engines/check": {
            "post": {
                "security": [
                    {
                        "Bearer": []
        ...
        "/system/admin/sandbox-configs/check": {
            "post": {
                "security": [
                    {
                        "Bearer": []
        ...
        "/system/admin/sandbox-configs/default": {
            "put": {
                "security": [
                    {
                        "Bearer": []
                ...
                "parameters": [
                    {
                        "description": "Default sandbox config",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/internal_handler.sandboxDefaultRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/system/admin/sandbox-configs/templates/query": {
            "post": {
                "security": [
                    {
                        "Bearer": []
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/internal_handler.sandboxTemplateQueryRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/system/admin/sandbox-configs/{id}": {
            "get": {
                "security": [
                    {
                        "Bearer": []
        ...
        "/system/admin/sandbox-configs/{id}/sandboxes": {
            "get": {
                "security": [
                    {
                        "Bearer": []
        ...
        "/system/admin/sandbox-configs/{id}/skills": {
            "get": {
                "security": [
                    {
                        "Bearer": []
        ...
        "/system/admin/sandbox-configs/{id}/skills/{skillId}": {
            "get": {
                "security": [
                    {
                        "Bearer": []
        ...
        "/system/admin/sandbox-configs/{id}/skills/{skillId}/files": {
            "get": {
                "security": [
                    {
                        "Bearer": []
        ...
        "/system/admin/sandbox-configs/{id}/skills/{skillId}/files/content": {
            "get": {
                "security": [
                    {
                        "Bearer": []
        ...
        "/system/admin/sandbox-configs/{id}/skills/{skillId}/install-events": {
            "get": {
                "security": [
                    {
                        "Bearer": []
        ...
        "/system/admin/sandbox-configs/{id}/skills/{skillId}/reinstall": {
            "post": {
                "security": [
                    {
                        "Bearer": []
        ...
        "/system/admin/sandbox-configs/{id}/skills/{skillId}/stop": {
            "post": {
                "security": [
                    {
                        "Bearer": []
        ...
        "/system/admin/sandbox-configs/{id}/skills/{skillId}/transcript": {
            "get": {
                "security": [
                    {
                        "Bearer": []
        ...
        "/system/admin/sandbox-configs/{id}/skills/{skillId}/transcript/history": {
            "get": {
                "security": [
                    {
                        "Bearer": []
                ...
                "responses": {
                    "200": {
                        "description": "Persisted install messages",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
                    ...
                    "404": {
                        "description": "Skill or transcript history not found",
                        "schema": {
                            "$ref": "#/definitions/github_com_Tencent_WeKnora_internal_errors.AppError"
                        }
                    }
        ...
        "/system/admin/skills/{id}/files/content": {
            "get": {
                "security": [
                    {
                        "Bearer": []
        ...
        "/system/admin/skills/{id}/install": {
            "post": {
                "security": [
                    {
                        "Bearer": []
        ...
        "/system/admin/storage-backends/test": {
            "post": {
                "security": [
                    {
                        "Bearer": []
        ...
        "/system/admin/storage-backends/types": {
            "get": {
                "security": [
                    {
                        "Bearer": []
        ...
        "/system/admin/storage-backends/{id}": {
            "get": {
                "security": [
                    {
                        "Bearer": []
            ...
            "put": {
                ...
                "responses": {
                    ...
                    "400": {
                        "description": "Immutable field change, validation, or connectivity failure",
                        "schema": {
                            "$ref": "#/definitions/github_com_Tencent_WeKnora_internal_errors.AppError"
                        }
                    },
            ...
            "delete": {
                ...
                "responses": {
                    ...
                    "400": {
                        "description": "Backend is default or bound",
                        "schema": {
                            "$ref": "#/definitions/github_com_Tencent_WeKnora_internal_errors.AppError"
                        }
                    },
        ...
        "/system/admin/storage-backends/{id}/default": {
            "put": {
                "security": [
                    {
                        "Bearer": []
        ...
        "/system/admin/storage-backends/{id}/test": {
            "post": {
                "security": [
                    {
                        "Bearer": []
        ...
        "/system/admin/vector-stores/test": {
            "post": {
                "security": [
                    {
                        "Bearer": []
        ...
        "/system/admin/vector-stores/types": {
            "get": {
        ...
        "/system/admin/vector-stores/{id}": {
            ...
            "delete": {
                ...
                "responses": {
                    ...
                    "400": {
                        "description": "Store is default or referenced",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
        ...
        "/system/admin/vector-stores/{id}/test": {
            "post": {
                "security": [
                    {
                        "Bearer": []
        ...
        "/system/admin/web-search-providers": {
            "post": {
                "security": [
                    {
                        "Bearer": []
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/internal_handler.CreateProviderRequest"
                        }
                    }
                ],
                "responses": {
                    "201": {
                        "description": "创建后的 Provider",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
        ...
        "/system/admin/web-search-providers/test": {
            "post": {
                "security": [
                    {
                        "Bearer": []
        ...
        "/system/admin/web-search-providers/types": {
            "get": {
                "security": [
                    {
                        "Bearer": []
        ...
        "/system/admin/web-search-providers/{id}": {
            "get": {
                "security": [
                    {
                        "Bearer": []
        ...
        "/system/admin/web-search-providers/{id}/credentials": {
            "put": {
                "security": [
                    {
                        "Bearer": []
        ...
        "/system/admin/web-search-providers/{id}/credentials/{field}": {
            "delete": {
                "security": [
                    {
                        "Bearer": []
        ...
        "/system/admin/web-search-providers/{id}/test": {
            "post": {
                "security": [
                    {
                        "Bearer": []
    ...
    "definitions": {
        ...
        "github_com_Tencent_WeKnora_internal_types.AuditAction": {
            ...
            "enum": [
                ...
                "system.model_runtime_changed",
                "system.ollama_download_started",
                "system.retrieval_processing_changed",
        ...
        "github_com_Tencent_WeKnora_internal_types.E2BSandboxConfig": {
            ...
            "properties": {
                ...
                "on_timeout": {
                    "description": "OnTimeout is pause (default) or kill for backends without automatic pause.",
                    "type": "string"
                },
                "proxy_url": {
        ...
        "github_com_Tencent_WeKnora_internal_types.KnowledgeBase": {
            ...
            "properties": {
                ...
                "storage_provider_config": {
                    "description": "Storage provider config records the provider used by historical objects;\ncredentials come from the bound platform storage backend.",
                    "allOf": [
                        {
        ...
        "github_com_Tencent_WeKnora_internal_types.MCPService": {
            ...
            "properties": {
                ...
                "is_builtin": {
                    "description": "Whether this platform definition is protected by the builtin edit policy",
                    "type": "boolean"
                },
                "name": {
                    "type": "string"
        ...
        "github_com_Tencent_WeKnora_internal_types.MemoryRuntimeConfig": {
            "type": "object",
            "properties": {
                "embedding_model_id": {
                    "type": "string"
        ...
        "github_com_Tencent_WeKnora_internal_types.ParserEngineConfig": {
            ...
            "properties": {
                "chat_parser_engine_rules": {
                    "description": "ChatParserEngineRules supplies the deployment default for session-scoped\ndocuments. An explicit agent rule or request selection takes precedence.",
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/github_com_Tencent_WeKnora_internal_types.ParserEngineRule"
                    }
        ...
        "github_com_Tencent_WeKnora_internal_types.PlatformChatHistoryConfig": {
            "type": "object",
            "properties": {
                "embedding_model_id": {
                    "type": "string"
        ...
        "github_com_Tencent_WeKnora_internal_types.Tenant": {
            ...
            "properties": {
                ...
                "memory_config": {
                    "description": "Memory config: enterprise consent for cross-session long-term memory.",
                    "allOf": [
                        {
                            "$ref": "#/definitions/github_com_Tencent_WeKnora_internal_types.TenantMemoryConfig"
                        }
                    ]
                },
                "memory_generation": {
                    "description": "MemoryGeneration invalidates every outstanding memory write whenever the\nworkspace memory policy actually changes.",
                    "type": "integer"
                },
                "name": {
                    "description": "Name",
        ...
        "github_com_Tencent_WeKnora_internal_types.TenantMemoryConfig": {
            "type": "object",
            "properties": {
                "enabled": {
        ...
        "github_com_Tencent_WeKnora_internal_types.TenantSandboxConfig": {
            ...
            "properties": {
                ...
                "skill_preparation": {
                    "description": "SkillPreparation selects validated per-session installation instead of snapshots.",
                    "type": "string"
                },
                "skill_rollout": {
        ...
        "github_com_Tencent_WeKnora_internal_types.WebSearchProviderEntity": {
            ...
            "properties": {
                ...
                "is_default": {
                    "description": "Whether this is the single platform default.",
                    "type": "boolean"
                },
                "name": {
        ...
        "internal_handler.CreateProviderRequest": {
            "type": "object",
            "required": [
                "name",
                "provider"
        ...
        "internal_handler.sandboxDefaultRequest": {
            "type": "object",
            "required": [
                "config_id"
            ],
        ...
        "internal_handler.sandboxTemplateQueryRequest": {
            "type": "object",
            "properties": {
                "config": {
                    "$ref": "#/definitions/github_com_Tencent_WeKnora_internal_types.TenantSandboxConfig"
        ...
        "internal_handler_session.CreateKnowledgeQARequest": {
            ...
            "properties": {
                ...
                "assistant_mode": {
                    "description": "Employee assistant: quick (default) or deep",
                    "type": "string"
                },
                "attachment_ids": {
