export default {
  ...
  memoryWorkspaceSettings: {
    ...
    runtimeDisabledTitle: 'Долговременная память не включена для этой организации',
    runtimeDisabledDescription: 'Администратор организации может включить долговременную память в настройках организации. После включения здесь появятся настройки выполнения.',
