export default {
  enterpriseSkills: {
    "title": "Навыки помощника сотрудников",
    "description": "Доступные помощнику сотрудников навыки централизованно настраивает администратор платформы.",
    "empty": "Сейчас нет доступных навыков. Их конфигурацией централизованно управляет администратор платформы.",
    "loadError": "Навыки недоступны. Попросите администратора платформы проверить песочницу помощника."
},
  platformApiKeys: {
  ...
  tenantMember: {
    ...
    audit: {
      ...
      action: {
        ...
        'knowledge_role.created': 'Бизнес-роль создана', 'knowledge_role.updated': 'Бизнес-роль обновлена', 'knowledge_role.member_assigned': 'Бизнес-роли участника обновлены', 'knowledge_access.updated': 'Доступ к знаниям обновлён'
      },
      columns: {
        time: 'Время',
        actor: 'Инициатор',
    ...
    remove: {
      ...
      confirmBody: 'Приостановить доступ для {name}? Доступ будет отозван немедленно, а прежняя роль сохранится при восстановлении.',
      confirm: 'Приостановить',
      success: 'Статус участника обновлён'
    },
    restore: {
      button: 'Восстановить',
      confirmBody: 'Восстановить {name} с прежней ролью?',
      confirm: 'Восстановить'
    },
    transfer: {
      button: 'Передать владение',
      confirmBody: 'Передать владение {name}? Вы станете администратором.',
      confirm: 'Передать',
      success: 'Владение передано'
    },
    add: {
      button: 'Пригласить',
    ...
    role: {
      owner: 'Владелец',
      admin: 'Администратор',
      contributor: 'Администратор знаний',
      viewer: 'Сотрудник'
    },
    status: {
      active: 'Активен',
  ...
  businessRoles: {
    title: 'Бизнес-роли', description: 'Бизнес-роли определяют только доступ сотрудников к знаниям и не меняют системные роли.', create: 'Добавить роль', rename: 'Переименовать роль', nameRequired: 'Введите название роли', createFailed: 'Не удалось добавить роль', saveFailed: 'Не удалось сохранить роль',
    columns: { name: 'Название роли', enabled: 'Включена', actions: 'Действия' }
  },
  knowledgeAccess: {
    title: 'Доступ к знаниям', description: 'Без выбранных ролей знания доступны всем сотрудникам организации. При выборе ролей доступ получают только их участники.', all: 'Все сотрудники', roles: 'Выбранные бизнес-роли', noRoles: 'Нет доступных бизнес-ролей. Попросите администратора создать роль.', disabled: 'Отключена', loadFailed: 'Не удалось загрузить доступ', roleRequired: 'Выберите хотя бы одну бизнес-роль', saved: 'Доступ к знаниям сохранён', saveFailed: 'Не удалось сохранить доступ'
  },
  userProfile: {
  ...
  agentEditor: {
    ...
    desc: {
      ...
      maxTokensAgent: 'Максимум токенов за один раунд рассуждения, включая JSON вызовов инструментов. «По умолчанию»: 4096 без песочницы, 24576 с записью/правкой файлов. Своё значение сохраняется как введено; при наличии песочницы среда выполнения применяет минимум 8192.',
  ...
  kbSettings: {
    ...
    storage: {
      ...
      defaultRequired: 'Платформенное хранилище по умолчанию не настроено. Сначала настройте его в разделе хранилищ.',
    ...
    vectorStore: {
      ...
      engineDesc: 'Выберите векторное хранилище из глобальной конфигурации. Для новой базы знаний предварительно выбирается значение платформы по умолчанию.',
      boundLabel: 'Bound vector store',
      systemDefault: 'System default',
      selectPlaceholder: 'Выберите векторное хранилище',
      defaultTag: 'По умолчанию для платформы',
      defaultRequired: 'Векторное хранилище по умолчанию для платформы не настроено. Сначала настройте его.',
  ...
  modelSettings: {
    ...
    runtimeContext: {
      ...
      retrievalTitle: 'План поиска и обработки документов', embedding: 'Ссылка возможности векторизации', reranking: 'Ссылка возможности переранжирования', parsing: 'Ссылка возможности разбора',
      unavailable: 'Контекст плана недоступен. Настройки моделей остаются только для платформы.',
      retrievalUnavailable: 'Контекст плана недоступен. Настройки поиска и обработки остаются только для платформы.'
    },
    copySuffix: ' копия',
  ...
  knowledgeEditor: {
    ...
    postCreateHint: {
      ...
      footer: 'Перед загрузкой документов проверьте доступ к знаниям. При необходимости настройте источники данных, затем сохраните и закройте.',
    ...
    basic: {
      ...
      typeDescription: 'Документы подходят для регламентов, договоров и инструкций; вопросы и ответы — для типовых обращений.',
  ...
  knowledgeList: {
    ...
    uninitializedEnterpriseBanner: 'Поиск в некоторых базах знаний ещё не настроен. Обратитесь к администратору платформы.',
  ...
  createChat: {
    starters: {
      returns: 'Как оформить возврат покупателя? Укажите источник правил.',
      handover: 'Помогите составить чек-лист передачи смены магазина.',
      training: 'Какие стандарты обслуживания должен знать новый сотрудник?',
    },
    workspaceLabel: 'Помощник сотрудника',
    description: 'Находите правила и уточняйте рабочие процессы. Ответы указывают источники и сообщают о недостающих данных.',
  ...
  memorySettings: {
    ...
    scopes: { shared: 'Все ассистенты', employee: 'Ассистент сотрудника', analysis: 'Операционный анализ' },
    scopeHints: {
      shared: 'Доступно ассистенту сотрудника и операционному анализу (анализ пока читает только предпочтения)',
      employee: 'Используется только ассистентом сотрудника',
      analysis: 'Используется только операционным анализом'
    },
    usage: {
  ...
  envVarSettings: {
    ...
    description: 'Личные ключи для навыков и песочниц, а не системные или деплой-настройки Huanshu.',
    ...
    noConfigDescription: 'На платформе пока нет подключения к песочнице, поэтому задавать ключи не для чего.',
    ...
    skillHint: 'Каждый навык объявляет необходимые значения. Личные значения можно сохранить здесь или передать в разговоре. Администратор платформы может задать общие значения по умолчанию на карточке навыка.',
    ...
    statusWorkspace: 'Используется значение платформы по умолчанию',
    ...
    clearConfirm: 'Удалить ваше значение для {name}? После этого снова применится значение платформы по умолчанию, если оно задано.',
  ...
  chatHistorySettings: {
    ...
    description: 'Настройте единую платформенную политику; индексы разговоров остаются изолированными по арендаторам',
    enableLabel: 'Включить индексацию сообщений',
    enableDescription: 'При включении новые подходящие сообщения индексируются. Отключение останавливает новые задания; уже поставленные в очередь могут завершиться.',
    ...
    embeddingModelLocked: 'Есть индексы арендаторов, поэтому можно повторно выбрать только прежнюю модель. Перед выбором другой модели Embedding очистите внутренние индексы.',
  ...
  vectorStoreSettings: {
    ...
    defaultRequired: 'Выберите векторную базу данных по умолчанию для новых баз знаний.',
    defaultTag: 'По умолчанию',
    setDefault: 'Сделать по умолчанию',
    defaultUpdated: 'Векторная база данных по умолчанию обновлена',
    basicSection: 'Основное',
  ...
  settings: {
    ...
    sandbox: {
      ...
      description: 'Настройка общих платформенных подключений к песочнице для выполнения навыков агента.',
      pageHintTitle: 'Что такое песочница?',
      pageHint: 'Песочница — изолированная среда для скриптов навыков агента. На платформе можно создать несколько подключений Docker, E2B и CubeSandbox; новые сессии используют подключение по умолчанию, а существующие сохраняют закреплённое подключение.',
      editorDescription: 'Настройка платформенной среды выполнения. Docker, CubeSandbox и E2B используют единый процесс управления.',
      ...
      backendDescriptions: {
        ...
        docker: 'Держит долгоживущий контейнер на каждую сессию на этом хосте Huanshu; скрипты и файлы остаются в том же контейнере',
      },
      ...
      dockerHostRisk: 'Пустое значение или unix:// использует демон Docker на машине Huanshu — это равносильно root на этой машине. Только для частной одноузловой установки. Если несколько пространств делят один хост, используйте Cube или E2B. Удалённый tcp:// требует каталог TLS-сертификатов.',
      addConfig: 'Добавить песочницу',
      setDefault: 'Сделать по умолчанию',
      defaultUpdated: 'Песочница по умолчанию обновлена',
      defaultUpdateFailed: 'Не удалось обновить песочницу по умолчанию',
      ...
      noConfigs: 'На платформе не настроена песочница, поэтому агенты не могут выполнять скрипты навыков.',
      ...
      inventorySessions: 'ID активных сессий',
      inventorySessionKind: 'ID сессии',
      ...
      blockedHint: 'Попросите администратора предприятия завершить или удалить эти сессии либо создайте вторую конфигурацию и назначьте её агентам.',
      ...
      namedBackendHint: 'Платформенное подключение к песочнице служит средой выполнения; новые сессии используют подключение по умолчанию.',
      weknoraTemplateTitle: 'Huanshu standard template',
      weknoraDockerImage: 'Huanshu standard image',
      ...
      weknoraTemplateOverview: 'Huanshu provides the standard runtime. Templates are discovered after connecting and the standard one is created when missing.',
      weknoraTemplateDescription: 'Includes the Python, Node.js, CLI tools, workspace path, and non-root execution user expected by Huanshu skills.',
      ...
      templateLoadHint: 'Введите подключение к кластеру и обновите список. Если стандартного шаблона Huanshu нет, нажмите «Создать»; после смены DNS или образа — «Удалить и пересобрать».',
      templateLoadFailed: 'Failed to load templates',
      standardTemplateProvisioning: 'The Huanshu standard template is being created. Refresh shortly to see its status.',
      ...
      templateStepHint: 'На этом шаге только перечисляются шаблоны, уже есть в кластере; ничего не создаётся автоматически. Если стандартного шаблона нет, нажмите «Создать стандартный шаблон Huanshu»; после смены DNS или образа — «Удалить и пересобрать». Продолжить можно, когда шаблон готов.',
      ...
      templateUntaggedHint: 'Сборки завершены, но ни одна не имеет тега default, поэтому при создании песочницы шаблон не находится. Удалите его в E2B и обновите список — Huanshu пересоберёт шаблон.',
      templateFailedReason: 'Сборка не удалась: {reason}',
      noTemplates: 'No templates were returned by this cluster.',
      weknoraStandardTemplate: 'Стандартный шаблон Huanshu',
      ...
      replaceStandardTemplateConfirm: 'Стандартный шаблон Huanshu будет собран заново с текущими настройками, включая DNS. Предыдущий готовый шаблон не удаляется, пока замена не станет готовой к запуску.',
      ...
      cubeDnsServersHelp: 'Необязательно. IP nameserver, которые записываются в стандартный шаблон Huanshu. Пустое значение оставляет значение кластера по умолчанию (обычно 119.29.29.29). Если UDP/53 до публичных резолверов недоступен, укажите достижимые адреса из /etc/resolv.conf хоста Cube, исключая 10/8, 172.16/12 и 192.168/16. Чтобы изменение вступило в силу, на карточке шаблона нажмите «Пересобрать».',
      ...
      dockerTlsCertPathHelp: 'Directory on the Huanshu host holding ca.pem, cert.pem and key.pem. Required for a remote daemon; certificates are mounted by the deployment, never stored here.',
      dockerIdleTtl: 'Idle reclaim (seconds)',
      dockerIdleTtlHelp: 'The Docker daemon has no idle timeout of its own. A container that runs no command for this long is reclaimed by Huanshu and rebuilt when the session continues. Empty means 1800 seconds.',
      ...
      envKey: 'Name',
      envValue: 'Value',
      envVarsHint: 'Передаются во все песочницы, использующие это платформенное подключение. Значения хранятся зашифрованными, но видны скриптам внутри песочницы.',
      addRow: 'Add variable',
      removeRow: 'Remove',
      save: 'Save',
      ...
      skillEnv: {
        ...
        platformTitle: 'Общие значения платформы по умолчанию',
        platformHint: 'Эти значения применяются, когда у текущего предприятия и пользователя нет личного значения. Личные значения задаются в разделе «Ключи песочницы».',
        ...
        save: 'Сохранить',
        saveSuccess: 'Значения платформы по умолчанию сохранены',
        saveFailed: 'Не удалось сохранить значения платформы по умолчанию.',
        clear: 'Очистить',
        clearConfirm: 'Очистить значение платформы по умолчанию для {name}? Объявление останется, но пользователи без личного значения не получат его.',
        clearSuccess: 'Значение платформы по умолчанию очищено.',
        valueTooLong: 'Значение не может превышать {max} байт.'
      },
    },
    skills: {
      title: 'Управление навыками',
      description: 'Навыки находятся в каталоге платформы. Их можно зарегистрировать и установить в одну или несколько песочниц. Агент включает только навыки, готовые в выбранной песочнице.',
      ...
      addStepRegisterDesc: 'Вставьте источник или загрузите zip, чтобы сначала добавить навык в каталог платформы.',
    ...
    storageBackend: {
      ...
      defaultTag: 'По умолчанию',
      defaultRequired: 'Выберите хранилище по умолчанию для новых баз знаний.',
  ...
  agent: {
    ...
    editor: {
      ...
      automaticModel: 'Выбирать модель автоматически',
      automaticModelHint: 'Если модель не указана, сначала используется модель чата, заданная базой знаний. Если база знаний не задаёт модель, используется модель платформы по умолчанию или другая доступная модель чата.',
      automaticModelUnavailableHint: 'Сейчас нет доступных моделей чата. Автовыбор можно сохранить, но перед запуском нужно настроить и активировать хотя бы одну модель.',
      platformModelDesc: 'Выберите модель чата для этого агента платформы или оставьте автовыбор.',
      builtinModeFixed: 'Фиксированный режим: {mode}',
      employeeBuiltinModeHint: 'Сотрудники могут выбрать быстрый запрос или глубокую обработку. Оба режима используют эту конфигурацию; быстрый режим ограничивает возможности инструментов.',
  ...
  newUserGuide: {
    ...
    steps: {
        ...
        title: 'Всё готово',
        desc: 'Теперь вы знакомы с помощником сотрудников, корпоративными знаниями и операционным анализом. Вернуться к обучению можно кнопкой помощи рядом с именем.'
      },
      models: {
      ...
      analysis: {
        title: 'Откройте операционный анализ',
        desc: 'Исследуйте управляемые бизнес-данные, находите отклонения и получайте выводы с подтверждающими данными.'
      },
      welcome: {
        title: 'Добро пожаловать в Huanshu',
        desc: 'Несколько простых шагов познакомят вас с помощником сотрудников, корпоративными знаниями и операционным анализом. Нажмите «Далее», чтобы начать.'
      }
    }
  },
  chatHeader: {
