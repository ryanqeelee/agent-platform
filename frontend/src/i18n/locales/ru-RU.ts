export default {
  ...
  tenantMember: {
    title: 'Участники',
    sectionDescription: 'Администраторы могут приглашать, приостанавливать и восстанавливать Сотрудников и Администраторов знаний. Владельцы могут назначать и снимать Администраторов и передавать владение.',
