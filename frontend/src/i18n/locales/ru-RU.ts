export default {
  enterpriseSkills: {
    ...
    "description": "Выберите навыки помощника вашей организации. Новые навыки и зависимости устанавливает администратор платформы.",
    "empty": "Навыки не установлены. Обратитесь к администратору платформы.",
    "ready": "Готов",
    "notReady": "Не готов",
    "enable": "Включить {name}",
    "loadError": "Навыки недоступны. Попросите администратора платформы проверить песочницу помощника.",
    "saveError": "Не удалось сохранить настройку навыка. Повторите попытку."
},
  platformApiKeys: {
