<template>
  <div class="storage-backend-settings">
    ...
    <t-alert v-if="!loading && !defaultID" theme="warning" :message="t('settings.storageBackend.defaultRequired')" />
      ...
      <t-form :data="form" layout="vertical">
        ...
        <section class="setting-drawer__section">
          ...
          <div class="form-item">
            ...
            <t-input v-model="form.config.path_prefix" :disabled="!!editing" placeholder="agent/" clearable />
          </div>
          <div v-if="form.provider === 'minio'" class="form-item">
...
const canEdit = (_backend: StorageBackend) => authStore.isSystemAdmin
const canDelete = (_backend: StorageBackend) => authStore.isSystemAdmin
