...
func (c *resolvingCatalog) ResolveTenantPath(
	_ context.Context, _ uint64, value string,
) (string, *types.StoredResource, error) {
	return c.ResolvePath(context.Background(), value)
}

func (c *resolvingCatalog) ListKnowledgeBindings(context.Context, string) ([]*types.ResourceBinding, error) {
	return nil, nil
}
