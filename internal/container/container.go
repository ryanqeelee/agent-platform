...
func BuildContainer(container *dig.Container) *dig.Container {
	...
	must(container.Provide(service.NewEnterpriseAdministrationService))
	...
	must(container.Provide(service.NewPlatformAgentService))
	...
	must(container.Provide(service.NewTenantMemoryConfigService))
	...
	must(container.Provide(handler.NewEnterpriseAdministrationHandler))
	...
	must(container.Provide(handler.NewPlatformAgentHandler))
