...
const productBaseVersion = "v0.8.0"
...
func (h *SystemHandler) GetSystemInfo(c *gin.Context) {
	...
	// Retain deployment diagnostics for explicitly environment-managed MinIO.
	minioEnabled := os.Getenv("MINIO_ENDPOINT") != "" &&
...
// sanitizeStorageCheckError converts a storage connectivity error into a safe
// user-facing message without leaking internal network details.
