...
func TestPlatformTenantOptionalAPIs(t *testing.T) {
	cases := []struct {
		...
		{http.MethodPost, "/api/v1/system/edge-node-revocations", true},
		{http.MethodGet, "/api/v1/system/edge-node-revocations", false},
		{http.MethodPost, "/api/v1/system/edge-node-revocations/extra", false},
