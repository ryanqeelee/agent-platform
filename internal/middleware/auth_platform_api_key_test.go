...
func TestPlatformTenantOptionalAPIs(t *testing.T) {
	cases := []struct {
		...
		{http.MethodPut, "/api/v1/system/tenants/10001/edge-binding", true},
		{http.MethodGet, "/api/v1/system/tenants/10001/edge-binding", false},
		{http.MethodPut, "/api/v1/system/tenants/10001/edge-binding/extra", false},
